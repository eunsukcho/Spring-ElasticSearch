        ...
        timeout: 10000,
		   ...
		   success: function(data)
		   {
			   ...
			   $.each(results , function(i){
	                str += '<tr><td><input type="checkbox"></td><td>' + results[i].yuhan_MESSAGE_FROM_MEMBER_NUMBER;
			...
			$('#menuBtn2').on('click', function()
				...
				$.ajax({
					   ...
					   success: function(data)
					   {
						   ...
						   var results = data;
						   var str = '<tr class="w3-teal"><th><input type="checkbox"></th><th>Send To</th><th>Subject</th><th>Send Date</th><th>Read Date</th></tr>';
						   ...
						   $.each(results , function(i){
							   ...
							   if(results[i].YUHAN_MESSAGE_READ_DATE != null)
				                ...
				                str += '<tr><td><input type="checkbox"></td><td>' + results[i].yuhan_MESSAGE_TO_MEMBER_NUMBER + '</td>';
				                str += '<td>' + results[i].yuhan_MESSAGE_SUBJECT + '</td><td>'+results[i].YUHAN_MESSAGE_SEND_DATE+'</td><td>'+printDate+'</td></tr>';
				            });
				           $("#myTable").append(str);
					   }
					});
